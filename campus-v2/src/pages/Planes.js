  ...
  container.innerHTML = `
    <div style="flex: 1; display: flex; flex-direction: column; overflow-y: auto; padding: 40px; position: relative;">
      ...
      <div style="max-width: 1000px; margin: 0 auto; padding: 60px 0; text-align: center; animation: fadeIn 0.8s ease-out;">
        ...
        <p style="color: var(--text-secondary); font-size: 1.2rem; max-width: 600px; margin: 0 auto 24px;">Desbloquea el acceso a las lecciones, mentorias en vivo y la red de talento MetodologIA.</p>
        ...
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 30px;">
          <div class="glass-panel" style="padding: 40px; border-radius: 20px; display: flex; flex-direction: column; transition: transform 0.3s, border-color 0.3s;" onmouseover="this.style.transform='translateY(-10px)'; this.style.borderColor='rgba(255,255,255,0.2)'" onmouseout="this.style.transform='translateY(0)'; this.style.borderColor='var(--panel-border)'">
            ...
            <div style="font-size: 2.5rem; font-weight: 800; margin-bottom: 24px;">$57<span style="font-size: 1rem; font-weight: 500; color: var(--text-secondary);">/mes</span></div>
            <ul style="text-align: left; list-style: none; padding: 0; margin: 0 0 40px 0; display: flex; flex-direction: column; gap: 12px; color: var(--text-secondary); font-size: 0.9rem;">
              ...
              <li><i data-lucide="check" style="width: 16px; color: var(--accent-color); margin-right: 8px;"></i> Ranking de maestria</li>
            </ul>
            <button onclick="window.buyPlan(event, 'price_monthly', 'basic', 'Plan Basic Mensual')" class="btn-primary" style="margin-top: auto; padding: 14px; justify-content: center; background: rgba(255,255,255,0.05); border-color: rgba(255,255,255,0.1);">Pagar Ahora</button>
          </div>
          ...
          <div class="glass-panel" style="padding: 40px; border-radius: 20px; display: flex; flex-direction: column; background: linear-gradient(135deg, rgba(99,102,241,0.15) 0%, rgba(139,92,246,0.15) 100%); border: 2px solid var(--accent-color); position: relative; transform: scale(1.05); box-shadow: 0 20px 40px rgba(0,0,0,0.3);">
            ...
            <div style="font-size: 2.5rem; font-weight: 800; margin-bottom: 24px;">$147<span style="font-size: 1rem; font-weight: 500; color: var(--text-secondary);">/3 meses</span></div>
            ...
            <button onclick="window.buyPlan(event, 'price_quarterly', 'premium', 'Plan Premium Trimestral')" class="btn-primary" style="margin-top: auto; padding: 14px; justify-content: center; box-shadow: 0 10px 20px var(--accent-glow);">Empezar Hoy</button>
          </div>

          <div class="glass-panel" style="padding: 40px; border-radius: 20px; display: flex; flex-direction: column; transition: transform 0.3s, border-color 0.3s;" onmouseover="this.style.transform='translateY(-10px)'; this.style.borderColor='rgba(255,255,255,0.2)'" onmouseout="this.style.transform='translateY(0)'; this.style.borderColor='var(--panel-border)'">
            <h3 style="font-size: 1.1rem; margin-bottom: 12px; color: var(--text-secondary);">Anual</h3>
            <div style="font-size: 2.5rem; font-weight: 800; margin-bottom: 24px;">$497<span style="font-size: 1rem; font-weight: 500; color: var(--text-secondary);">/ano</span></div>
            <ul style="text-align: left; list-style: none; padding: 0; margin: 0 0 40px 0; display: flex; flex-direction: column; gap: 12px; color: var(--text-secondary); font-size: 0.9rem;">
            ...
            <button onclick="window.buyPlan(event, 'price_yearly', 'enterprise', 'Plan Enterprise Anual')" class="btn-primary" style="margin-top: auto; padding: 14px; justify-content: center; background: rgba(255,255,255,0.05); border-color: rgba(255,255,255,0.1);">Pagar Pago Unico</button>
          </div>
        </div>

        <p style="margin-top: 50px; color: var(--text-secondary); font-size: 0.85rem;">Pagos seguros procesados por Stripe. Cancela en cualquier momento.</p>
      </div>
